...
- **Towards a Tokenomics-Driven Decentralized Ecosystem for Agent Society.** <br><strong><u>Xi Zhu</u></strong>, Zhuoqiao Shen, Ziqi Wang, Shuhang Lin, Minghao Guo, Yongfeng Zhang. <br>Preprint.

- **Individual Turing Test: A Case Study of LLM-based Simulation Using Longitudinal Personal Data.**  <br>Minghao Guo, Ziyi Ye, Wujiang Xu, <strong><u>Xi Zhu</u></strong>, Weihang Su, Shuqi Zhu, Yujia Zhou, Yongfeng Zhang, Qingyao Ai, Yiqun Liu. <br>In Proceedings of the 49th International ACM SIGIR Conference on Research and Development in Information Retrieval (**SIGIR 2026**), 2026. [[Link]](https://arxiv.org/abs/2603.01289) 
